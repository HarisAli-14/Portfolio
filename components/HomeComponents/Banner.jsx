            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-0 md:flex items-center justify-between w-full px-4 xl:px-8 2xl:px-16">
                    ...
                    <div className="flex items-center gap-x-1">
                        ...
                        <span className='text-xs text-Snow'>AI Projects</span>
                    </div>

                    <div className="flex items-center gap-x-1">
                        <span className='text-base md:text-lg text-Green font-bold'>3+</span>
                        <span className='text-xs text-Snow'>SaaS Platforms</span>
                    </div>

                    <div className="flex items-center gap-x-1">
                        <span className='text-base md:text-lg text-Green font-bold'>1+</span>
                        <span className='text-xs text-Snow'>Year Experience</span>
                    </div>

                    <div className="flex items-center gap-x-1">
                        <span className='text-base md:text-lg text-Green font-bold'>100%</span>
                        <span className='text-xs text-Snow'>AI-Powered</span>
                    </div>
