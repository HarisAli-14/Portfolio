...
import HarisProfile from '../../../public/images/haris-profile.png';

const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-3 overflow-hidden'>
        <div className='flex-shrink-0'>
          <Image 
            className='w-20 h-20 md:w-24 md:h-24 rounded-full object-cover border-2 border-Green shadow-lg' 
            src={HarisProfile} 
            alt='Haris Ali Wajid profile picture'
            width={96}
            height={96}
            quality={100}
          />
